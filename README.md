...
Activity synchronization is managed by the _Dynamics 365 activity synchronization_ [scheduled task](https://docs.xperience.io/x/Fg_RBg) by default set to run every hour. 
